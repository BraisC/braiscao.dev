...
<p>
  After that I committed myself to learn web development <span>on my own</span>, starting my with{' '}
  <span>CSS</span>, lately I have been fully focused on <span>Javascript</span> and its ecosystem,
  mostly <span>React</span> and all that surrounds it.
</p>
...
<p>
  Everytime I learn something new I build a <span>project</span> in order to consolidate the knowledge
...
<Stack>
  ...
  <p>
    <span>
      Typescript - Next.js - Vue - Express - Fastify - WebSockets - Firebase - Apollo - Three.js -
      GSAP - WebAssembly
    </span>
  </p>
</Stack>
