...
<ModalText>
  <p>
    A project fully designed and coded by me from scratch in order to practice <span>React</span>{' '}
    after completing the "Modern React with Redux" course from Udemy. Completely made using just{' '}
    <span>hooks</span> and the new <span>context API</span>. Also used <span>CSS Grid</span> for
    first time, loved it!
  </p>
  <p>
